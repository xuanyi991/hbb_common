...
pub const LINK_DOCS_HOME: &str = "https://www.cddccn.cn/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://www.cddccn.cn/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://www.cddccn.cn/rustdesk/rustdesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.cddccn.cn"];
pub const RS_PUB_KEY: &str = "44pAr5qR9uoKliZ6KofUbKMvz9k3hP4zO8UQfjPmvhE=";
